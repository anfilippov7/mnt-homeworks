...
2. В информации, представленной в событии указано наименование ошибки, тэги, включая те которые мы передвали в событии, а также python код и строка в которой произошла ошибка (номер строки 20) 

<p align="center">
  <img width="1200" height="600" src="./image/sentry4.png">
</p>

3. Переходим в список событий проекта, выбераем созданное и нажимаем `Resolved`.
