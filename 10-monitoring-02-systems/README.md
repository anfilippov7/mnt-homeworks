...
## Решение обязательные задания

1. Минимальный набор метрик для мониторинга доджен быть такой:
...
2. 
 - я подробно описал необходимые метрики мониторинга и для чего это нужно выше, менеджер проекта может ознакомиться.
